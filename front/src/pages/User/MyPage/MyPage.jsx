...
export default function MyPage() {
  ...
  return (
    <Section>
      ...
      <Section2>
        <div className='section2_title'>자격증 현 <p className='title_length'>1</p></div>
        <div className='section2_container'>
          ...
          <div className='section2_plus'>
            +
          </div>
        </div>
      </Section2>
      <Section3>
        <div className='section3_title'>직무 경험 <p className='title_length'>2</p></div>
        <div className='section3_flex'>
          ...
          <div className='section3_next'>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M13.477 9.16591H3.33366V10.8326H13.477L9.00699 15.3026L10.1853 16.4809L16.667 9.99924L10.1853 3.51758L9.00699 4.69591L13.477 9.16591Z" fill="#1F7CEB"/>
            </svg>
          </div>
        </div>
      ...
      <Section3>
        <div className='section3_title'>프로젝트 이력 <p className='title_length'>2</p></div>
        <div className='section3_flex'>
          <div className='section3_container'>
            <div className='section3_container_left'>
              <div className='section3_container_leftright_flex'>
...
const Section1Etc = styled.div`
  display: flex;
  flex-direction: column;
  .section1_etc_clip, .section1_etc_recruitment {
    width: 240px;
    height: 200px;
    border-radius: 30px;
    border: 2px solid #DAE9FC;
...
const Section3 = styled.div`
  ...
  .section3_container {
    ...
    display: flex;
    align-items: start;
    .section3_container_left, .section3_container_right{
      padding-top: 90px;
      width: 640px;
      display: flex;
      flex-direction: column;
